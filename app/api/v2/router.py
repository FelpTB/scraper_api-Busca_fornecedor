...
from app.api.v2 import serper, encontrar_site, scrape, montagem_perfil, queue_profile
...
router.include_router(queue_profile.router, prefix="/queue_profile", tags=["v2-queue"])
